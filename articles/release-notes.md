...
- **Comunidade do Power Automate reestruturada** – encontrar o que precisa na Comunidade do Power Automate é agora mais fácil.
...
- **Correções de widget de fluxo** – foi corrigido um problema na aplicação móvel Power Automate que fazia com que os botões deixassem de carregar no widget.
...
- **Aplicações do Dynamics 365** – o Power Automate está agora integrado na IU das aplicações do Dynamics 365, como o Dynamics 365 for Sales e o Dynamics 365 for Customer Service.
...
* **Visual Studio Team Services** – com o Power Automate, pode agora ligar o VSTS a um amplo leque de serviços, como o E-mail do O365, Slack e Trello.
...
* Há uma [nova comunidade](https://go.microsoft.com/fwlink/?LinkID=787467) onde pode falar sobre o Power Automate ou [submeter as suas ideias](https://go.microsoft.com/fwlink/?LinkID=787474).
