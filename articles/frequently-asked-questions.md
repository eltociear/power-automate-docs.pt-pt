...
O Power Automate é um serviço baseado na cloud que permite aos utilizadores de linha de negócio criar fluxos de trabalho de forma prática e simples que automatizam os processos e as tarefas demoradas em diferentes aplicações e serviços.

### <a name="who-is-the-intended-audience-for-power-automate"></a>Qual é a audiência alvo do Power Automate?
O Power Automate tem duas audiências distintas:
...
### <a name="how-do-power-automate-and-logic-apps-relate-to-each-other"></a>Qual a relação entre o Power Automate e o Logic Apps?
O Power Automate proporciona funcionalidades que ajudam os utilizadores da linha de negócio a criarem fluxos de trabalho automatizados. O Logic Apps é um serviço do Azure que proporciona as mesmas funcionalidades fantásticas do Power Automate, para além de funcionalidades como a integração no Azure Resource Manager, Portal do Azure, CLI do PowerShell e xPlat, Visual Studio e conectores adicionais. [Saiba mais sobre o Logic Apps](https://azure.microsoft.com/services/app-service/logic/).
...
O Power Automate suporta endereços de e-mail com uma qualquer terminação exceto .gov e .mil.  

### <a name="is-power-automate-available-on-premises"></a>O Power Automate no local está disponível?
O Power Automate é apenas um serviço de nuvem pública. No entanto, pode ligar-se em segurança aos seus serviços no local através do gateway de dados no local.

### <a name="what-services-can-power-automate-connect-to"></a>A que serviços o Power Automate pode ligar?
...
### <a name="how-do-i-connect-to-sql-server-and-other-on-premises-data-sources"></a>Como posso ligar-me ao SQL Server e a outras origens de dados no local?
...
### <a name="what-regions-and-languages-does-power-automate-support"></a>Que regiões e idiomas são suportados pelo Power Automate?
O Power Automate está disponível em 42 idiomas e em [seis regiões](regions-overview.md).

### <a name="how-does-power-automate-compare-to-sharepoint-designer-2013"></a>Como o Power Automate se compara com o SharePoint Designer 2013?
...
* Visitar a [aprendizagem interativa](https://docs.microsoft.com/learn/paths/automate-process-using-flow) do Power Automate
