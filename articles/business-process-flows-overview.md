...
## <a name="what-can-business-process-flows-do"></a>O que podem fazer os fluxos do processo de negócio?  
 ...
 ![Processos de negócio com fases](media/business-process-stages.png "Processos de negócio com fases")  
...
## <a name="business-process-flow-considerations"></a>Considerações sobre fluxos de processo de negócio  
 Pode definir fluxos de processos de negócio apenas nas entidades do suporte. Também tem de estar a par dos limites do número de processos, e de fases de passos que é possível adicionar.  
  
### <a name="business-process-flows-that-call-a-workflow"></a>Fluxos do processo de negócio que invocam um fluxo de trabalho  
...
-   Crie um fluxo do processo de negócio com três fases, onde S1 se liga à S2 e, em seguida, a S2 cria ramificações para a S3. Inclua um fluxo de trabalho na S2 e defina o acionador como **Saída de Fase**.  
 ...
 O fluxo de trabalho não será acionado em qualquer caso. Para resolver este problema, poderá adicionar um Fluxo de Trabalho Global e adicionar-lhe o fluxo de trabalho que pretende acionar para o fluxo de trabalho ser acionado para o processo de negócio, em vez de uma fase do processo. É possível definir o acionador para um fluxo de trabalho Global para o Processo Abandonado ou o Processo Concluído para o fluxo de trabalho ser acionado quando um utilizador abandona ou conclui o processo de negócio.  
  
<a name="BKMK_Entities"></a>   
### <a name="entities-that-can-use-business-process-flows"></a>Entidades que podem usar fluxos do processo de negócio  
...
## <a name="business-process-flow-entity-customization-support"></a>Suporte de personalização para entidades de fluxo do processo de negócio 
...
Os fluxos do processo de negócio, tais como o **Processo de Vendas da Oportunidade Potencial**, aparecem como uma entidade personalizável no explorador de soluções.

![Explorador de Soluções com a entidade do processo de oportunidade potencial à oportunidade](media/bpf-lead-solution-explorer.png)
...
Também pode interagir com entidades de fluxos de processo de negócio a partir de um fluxo de trabalho. Pode, por exemplo, criar um fluxo de trabalho para o registo de entidade do Fluxo do Processo de Negócio para alterar a Fase Ativa quando um campo do registo da entidade Oportunidade é atualizado. Para obter mais informações sobre como o fazer, veja [Automatizar fases de fluxos de processos de negócio com fluxos de trabalho](https://blogs.msdn.microsoft.com/crminthefield/2017/12/18/automate-business-process-flow-stages-using-workflows).
...
### <a name="limitations-of-using-business-process-flow-entities"></a>Limitações da utilização de entidades de fluxo do processo de negócio

- Atualmente, não é possível criar formulários personalizados para as entidades baseadas num fluxo do processo de negócio.
...
- A adição da entidade do processo a uma aplicação condicionada por modelo poderá limitar a funcionalidade. Saiba mais sobre como [criar e editar fluxos de processos de negócio](https://docs.microsoft.com/power-automate/create-business-process-flow). 

### <a name="next-steps"></a>Passos seguintes  
 [Assista a um pequeno vídeo (4:49) sobre os fluxos do processo de negócio](https://go.microsoft.com/fwlink/p/?linkid=842226)   
 [Criar um fluxo de processo de negócio](create-business-process-flow.md)   
 [Melhorar fluxos do processo de negócio com ramificação](enhance-business-process-flows-branching.md) <br/>
 [Documento técnico: Ativação de Processos com o Dynamics 365](https://download.microsoft.com/download/C/3/B/C3B46E35-9445-43B9-800B-474E022EE352/Process%20Enablement%20with%20Microsoft%20Dynamics%20CRM%202013.pdf)</br>
